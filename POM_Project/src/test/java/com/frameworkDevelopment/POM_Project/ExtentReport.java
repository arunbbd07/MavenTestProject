...
public class ExtentReport{
 ...
 extent
                .addSystemInfo("Host Name", "Page Object Model Developlment")
                .addSystemInfo("Environment", "Automation Testing-Arun's Laptop")
                .addSystemInfo("User Name", "Arun Kumar Yadav");
